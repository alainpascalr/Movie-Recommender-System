...
<head>
	...
	$query = "SELECT M.DateReleased, D.FirstName, D.LastName, D.Country, S.Name, S.Country, A.FirstName, A.LastName
	 ...
	 <?php  
	 	...
	 	require('connect.php');
	 	$query1 = "SELECT name, moviepic, language, trailer, MovieId
		From Movie
...
<div id="parent">
 ...
 <?php  }} ?>
		...
		<?php  
		require('connect.php');
		$query2 = "SELECT M.Name, M.moviepic, M.MovieID
		...
		$stmt2 = pg_prepare($link, 'psss',$query2);
		  ?>
...
<div id="recommendedmoviesection">
	<img src="<?php  echo $row2[1]; ?>" height="300" width="200">
	<h5 style="color: #FFFFFF"><?php echo $row2[0]; ?></h5>
            
    <a href = "moviedetails.php?movieid=<?php echo $row2[2];?>" class = "btn btn-default" id="btndefault" role = "button" style="width: 200px">
        More details
    </a>
</div>
 <?php  } ?>
